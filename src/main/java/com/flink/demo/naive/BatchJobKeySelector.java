package com.flink.demo.keyselector;

import com.flink.demo.wordcount.BatchJobWordCount;
...
public class BatchJobKeySelectorForPojo {
    ...
    public static void countWordSkipStopWords() throws Exception {
        ...
        DataSet<Tuple2<String, Integer>> wordCounts = text
                .flatMap(new BatchJobKeySelectorForPojo.LineSplitter())
                .returns(Types.TUPLE(Types.STRING, Types.INT))
                .groupBy(0)
                .sum(1);
        wordCounts.print();
